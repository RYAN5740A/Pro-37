...
// console.log( mousePressedOver(startButton))
    ...
    verticalBar= new VerticalProp(width/8,height/1-400,30,100)
    ...
    LeftAngledBar = new AngledProp(width/8+400,height/1-400,100,PI/7);
    LeftAngledBar.display()
    RightAngledProp= new AngledProp(width/8+600,height/1-100,100,-PI/7)
    RightAngledProp.shapeColor="steelblue"
    RightAngledProp.display()
